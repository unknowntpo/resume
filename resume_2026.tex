...
\begin{rSubsection}{}{}{}{}
		\item \textbf{Apache Gravitino Committer} ({\color{teal}\underline{\href{https://github.com/apache/gravitino}{GitHub}}}): implemented PostgreSQL/MySQL container-suite management for integration tests, built reproducible Docker image workflows, reduced Hive image size by \textbf{420MB}, and ported partition APIs to the Python client.
		\item \textbf{Apache Kafka Contributor} ({\color{teal}\underline{\href{https://github.com/apache/kafka}{GitHub}}}): fixed JVM container awareness in producer perf tests and corrected partition switching so offsets are committed before partition changes: {\color{teal}\underline{\href{https://github.com/apache/kafka/pull/21584}{PR \#21584}}}.
		\item \textbf{Apache DataFusion and Comet Contributor}: implemented Spark str-to-map in Rust ({\color{teal}\underline{\href{https://github.com/apache/datafusion/pull/20120}{PR \#20120}}}) and wired Comet's native SparkStrToMap UDF with SQL file coverage ({\color{teal}\underline{\href{https://github.com/apache/datafusion-comet/pull/3654}{PR \#3654}}}).
		\item \textbf{redis/rueidis Contributor} ({\color{teal}\underline{\href{https://github.com/redis/rueidis/pull/395}{PR \#395}}}): implemented the go-redis API Adapter for teams migrating from go-redis.
	\end{rSubsection}
\end{rSection}
...
\textbf{Data Warehouse / Lakehouse:} PostgreSQL, ClickHouse, Hive, StarRocks \\
\textbf{Streaming / Processing:} Kafka, Kafka Streams, Flink, Spark, SQL, dbt \\
